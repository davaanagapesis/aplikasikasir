...
<link rel="icon" href="icon.ico" type="image/ico">
  <title>APLIKASI KASIR TOKO CAHYA</title>
  <meta charset="utf-8">
...
<div class="row justify-content-center">
    ...
    <h1 class="h3 text-center mb-3" style="font-weight:600;">TOKO <span class="text-primary">CAHYA</span></h1>
	<img alt="logo" src="assets/img/cahya.png" height="110" width="390"/><p>
